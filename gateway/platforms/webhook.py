...
class WebhookAdapter(BasePlatformAdapter):
    ...
    async def _handle_webhook(self, request: "web.Request") -> "web.Response":
        ...
        # triggered the event, so it runs BEFORE the route script, prompt
        # render, skill load, and agent spawn — a non-allow-listed author is
        # ignored at the HTTP layer and never starts a worker (or a route
        # subprocess) on untrusted external input.
        #
